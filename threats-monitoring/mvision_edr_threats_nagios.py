#!/usr/bin/env python3
# Written by ondromalik. Based on fork by mohlcyber v.1.0.
                ...
                if len(res['threats']) > 0:
                    ...
                    for threat in res['threats']:
                        ...
                        if args.minimum_severity is not None:
                            ...
                            # Returns CRITICAL means new threat identified
                            # self.logger.info('CRITICAL - New threat identified'.format(res))
                            sys.stdout.write("CRITICAL - New threat identified")
                            exit(CRITICAL)

                    # self.logger.info('OK - No new threats identified'.format(res))
                    sys.stdout.write("OK - No new threats identified")
                    exit(OK)
...
if __name__ == '__main__':
    usage = """python mvision_edr_threats.py -R <REGION> -C <CLIENT_ID> -S <CLIENT_SECRET> -LL <LOG_LEVEL> -MS <MINIMUM SEVERITY>"""
